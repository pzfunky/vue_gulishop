                ...
                <table class="order-item" v-for="myOrder in myOrderInfo.records" :key="myOrder.id">
                    ...
                    <tbody>
                        <tr v-for="(orderDetail,index) in myOrder.orderDetailList" :key="orderDetail.id">
                            ...
                            <td v-if="index === 0" :rowspan="myOrder.orderDetailList.length" width="8%" class="center">小丽</td>
                            <td v-if="index === 0" :rowspan="myOrder.orderDetailList.length" width="13%" class="center">
                                <ul class="unstyled">
                                    <li>总金额¥{{orderDetail.orderPrice}}</li>
                                    <li>{{myOrder.paymentWay === 'ONLINE'?'在线支付':'货到付款'}}</li>
                                </ul>
                            </td>
                            <td v-if="index === 0" :rowspan="myOrder.orderDetailList.length" width="8%" class="center">
